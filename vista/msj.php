...
<body>
	...
	<div class="container-fluid">
		<aside>
			<div class="color6 col-xs-12 col-sm-4">
				<div class="well">
					<h3><strong>Correo</strong></h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate ipsa ipsum consequuntur vitae recusandae laboriosam ducimus veniam at placeat, sed maxime ullam nobis pariatur nemo debitis sapiente, perspiciatis, illo eos. </p>
				</div>

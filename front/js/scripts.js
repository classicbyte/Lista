       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Valpariso",  /* You can change your address from here */
            html: "<b>Address</b>: <br> Blanco 899, Valparaíso, Región de Valparaíso, Chile",   /* You can change display address text from here */
            popup: true
            }
            ]
            });

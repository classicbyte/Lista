...
<body class="">
	...
	<div class="container-fluid">
		<div class="well">
				<center><h2><strong>Confirmar para Eliminar Lista </strong></h2></center>
	...
	<div class="container-fluid">
		<div class="">
				...
				echo $html="<div class='color6 col-xs-6'>
							<form name='login' method='post' action='../controlador/delLs.php' enctype='application/x-www-form-urlencoded' class='inline'>
						...
						<div class='color6 col-xs-6'>
							<form name='login' method='post' action='listin.php' enctype='application/x-www-form-urlencoded' class='inline'>
